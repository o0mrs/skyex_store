...
const Front =()=>{
  ...
  if(view == 'online'){
    return(
      ...
      <>
      <NavBar/>
      <div className="hero min-h-screen" id='ddd3333'>
...
<footer id='footerr' className="p-10 footer sm:flex-0 md:flex-0 lg:flex-0  -mb-12 bg-base-200 text-base-content">
  <div>
