...
export default function Login() {
  ...
  return (
      ...
      <div className="roboto text-center text-3xl grid place-items-center">
        <img src='https://skyex.me/logo.png' className='-mt-10 max-w-[16rem]'></img>
        <div className="text-4xl font-bold">
        Sign in to skyex
        </div>
        <div className="mt-12 grid">
            <label className="text-sm mb-3 text-left roboto">Email address</label>
            <input className='border-0 input focus:outline-none h-12 -mt-2 border-transparent focus:border-transparent focus:ring-0 sm:w-[87vw]  bg-gray-100 md:w-96' placeholder={'ex@skyex.me'}/>
        </div>
        <div className="mt-4 grid">
            <label className="text-sm mb-3 text-left roboto">Password</label>
            <input className='border-0 input focus:outline-none h-12 -mt-2 border-transparent focus:border-transparent focus:ring-0 sm:w-[87vw]  bg-gray-100 md:w-96' placeholder={'*********'}/>
        </div>
        <div className='mt-6'>
