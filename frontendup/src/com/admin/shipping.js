...
settab('App')
  ...
  navigate('/admin/dashboard/noperm', { replace: false })
        ...
        setstatename('')
        setstateprice(0)
        setalart(statename + ' has been added')
...
<button onClick={()=>{
  ...
  <button className="btn btn-active"  role="button" aria-pressed="true">Edit States</button> 
  </div>

  <div className="grid place-items-center mt-4">
    {sprog == 0 &&(
  <button className="btn btn-active" role="button" aria-pressed="true" onClick={handle_save_region}>Save</button> 

    )}
    {sprog == 1 &&(
  <button className="btn btn-active loading">loading</button>
...
<div className='grid place-items-center'>
  ...
  <div className="grid place-items-center mt-4">
  <button className="btn btn-active" role="button" aria-pressed="true" onClick={()=>{settab('add_states')}}>Add States</button> 
...
<button onClick={()=>{
  ...
  <div className="grid place-items-center mt-4">
    {prog == 0 && (
  <button className="btn btn-active" role="button" aria-pressed="true" onClick={handle_add_state}>Add State</button> 
    )}
    {prog == 1 && (
      <button className="btn btn-active loading">loading</button> 
    )}
