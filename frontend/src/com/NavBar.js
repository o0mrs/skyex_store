                   ...
                   <div className="flex justify-between text-base font-medium text-gray-900">
                    ...
                    <div className="mt-6">
                      <span
                        ...
                        className="flex btn justify-center items-center px-6 py-3 border border-transparent rounded-md shadow-sm text-base font-medium text-white"
                      >
                        Checkout
                      </span>
                    </div>
        ...
        <Transition.Root show={open} as={Fragment}>
          <Dialog as="div" className="fixed inset-0 flex z-40 overflow-visible " onClose={setOpen}>
            ...
            <Transition.Child
              ...
              leaveTo="-translate-x-full"
            >
              <div className=" absolute max-w-[16rem] w-full rounded-xl bg-white max-h-[100vh] shadow-xl pb-12 flex flex-col ">
                <div className="px-4 pt-5 pb-2 ">
                  ...
                  >
                    ...
                    <i className="fa-solid float-right text-black  fa-x"></i>
                  </button>
                </div>
                ...
                <div className=" py-6  text-center text-black h-screen px-4 space-y-6">
            ...
            <div className=" border-gray-200">
              <div className="h-16 flex items-center">
                ...
                >
                  ...
                  <i className="fa-solid text-xl fa-bars-staggered"></i>
                </button>

                {/* Logo */}
                {/* <div className="ml-4 flex lg:ml-0" onClick={()=>{navigate('/', { replace: false })}}>

                    <a href="#">

                      <span className="sr-only">Skyex</span>
                      <img
                        className="h-14 w-auto"
                        src="https://skyex.me/logo.png"
                        alt="" />
                    </a>
...
{/* 
                  ...
                  <div className="ml-4 flow-root lg:ml-6">
                      ...
                      <ShoppingBagIcon
                        ...
                        aria-hidden="true" />
                      <span className="ml-2 text-sm font-medium text-gray-700 group-hover:text-gray-800">{productsnum}</span>
