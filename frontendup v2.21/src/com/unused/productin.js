...
axios.post(window.$api + '/idproduct',{
  ...
  const dd = Response.data.result[0].options
...
<>
<NavBar/>
    <div className="bg-white m-16 mt-0">
      <div className="pt-6">
          ...
          <div className="py-10 lg:pt-6 lg:pb-16 lg:col-start-1 lg:col-span-2 lg:border-r lg:border-gray-200 lg:pr-8">
            ...
            <div className="mt-10">
              ...
              <div className="mt-4 text-center">
                <div role="list" className="pl-4 list-disc text-sm space-y-2 text-center">
